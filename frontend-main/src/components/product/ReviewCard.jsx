    ...
    return (
        <div className="group relative bg-white rounded-2xl p-5 sm:p-6 lg:p-7 border border-gray-200 hover:border-gray-300 hover:shadow-2xl active:shadow-xl transition-all duration-300 h-full flex flex-col overflow-hidden">
            ...
            <div className="absolute top-5 right-5 opacity-5 group-hover:opacity-10 transition-opacity duration-300">
                <HiChatAlt2 className="w-16 h-16 sm:w-20 sm:h-20 text-gray-400" />
                ...
                <div className="flex items-center justify-between mb-4 sm:mb-5 relative z-10">
                        ...
                        <div className="flex items-center gap-0.5 sm:gap-1">
                            {[...Array(5)].map((_, i) => (
                                i < review.rating ? (
                                    <FaStar
                                        key={i}
                                        className="w-4 h-4 sm:w-5 sm:h-5 transition-all duration-200 text-yellow-400 scale-100 group-hover:scale-110"
                                    />
                                ) : (
                                    <FaRegStar
                                        key={i}
                                        className="w-4 h-4 sm:w-5 sm:h-5 transition-all duration-200 text-gray-200"
                                    />
                                )
                            ))}
                        </div>
                    ...
                    {/* Verified Purchase Badge - Small */}
                    {review.order && (
                        <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-green-50 rounded-full">
                            ...
                            <span className="text-xs font-medium text-green-600 hidden sm:inline">Verified</span>
                        </div>
                    )}
                </div>
                ...
                <div className="flex items-center justify-between gap-3 sm:gap-4 pt-4 sm:pt-5 border-t border-gray-100 relative z-10">
