 ...
 */
export default function DeleteConfirmModal({ order, isOpen, onClose, onConfirm, deleting }) {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true">
            <div className="flex items-center justify-center min-h-screen px-4 py-8">
                ...
                <div className="relative inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform bg-white rounded-xl shadow-2xl">
                    <div className="px-6 py-5">
                        ...
                        <p className="text-sm text-gray-600 text-center mb-6">
                            Are you sure you want to delete order <strong className="text-gray-900">#{order.orderNumber || order._id.slice(-8)}</strong>? <br />
