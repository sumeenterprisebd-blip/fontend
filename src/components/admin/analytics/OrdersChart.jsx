/**
 * Lightweight Orders Chart - CSS-based
 * Responsibility: Display orders trend with simple bars (No chart.js dependency)
 */
export default function OrdersChart({ chartData }) {
    if (!chartData || !chartData.labels || !chartData.ordersData) {
        return (
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-sm text-gray-600">
                    Total: {chartData.ordersData.reduce((a, b) => a + b, 0)} orders
                </div>
            </div>
            ...
            <div className="space-y-3 h-80 overflow-y-auto">
                {chartData.labels.map((label, index) => {
                    const orders = chartData.ordersData[index] || 0;
