...
export async function getServerSideProps({ params }) {
  ...
  try {
    ...
    const initialProduct = {
      ...
      pricingTiers: Array.isArray(fetchedProduct.pricingTiers) ? fetchedProduct.pricingTiers : [],
      measurements: Array.isArray(fetchedProduct.measurements) ? fetchedProduct.measurements : [],
      colors: Array.isArray(fetchedProduct.colors) ? fetchedProduct.colors : [],
      sizes: Array.isArray(fetchedProduct.sizes) ? fetchedProduct.sizes : [],
      isComboOffer: Boolean(fetchedProduct.isComboOffer),
      freeDelivery: Boolean(fetchedProduct.freeDelivery),
      freeDeliveryMinQty: Number.isFinite(Number(fetchedProduct.freeDeliveryMinQty)) ? Number(fetchedProduct.freeDeliveryMinQty) : 2,
